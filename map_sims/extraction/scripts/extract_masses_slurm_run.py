...
Usage: python extract_masses_slurm_run.py /path/to/maps_file /path/to/info_file --radii-file /path/to/radii_file --n-tasks 8 --env env
...
env: conda environment to use in slurm run
"""
#!/usr/bin/env python3
